...
import { translations, t, getTranslations } from './translations';
...
describe('t() translation helper', () => {
  ...
  it('interpolates parameters correctly into placeholders', () => {
    const resultEn = t('countryFilter.selectedCount', { count: 3, total: 17 }, 'en');
    expect(resultEn).toBe('3 of 17 countries selected');

    const resultFr = t('countryFilter.selectedCount', { count: 3, total: 17 }, 'fr');
    expect(resultFr).toBe('3 sur 17 pays sélectionnés');
  });
