...
export const translations = {
  ...
  'fr': {
    ...
    'countryFilter.showAll': 'Tout Afficher',
    ...
    'legend.religiousObservance': 'Observance Religieuse',
    'legend.traditionalCelebration': 'Célébration Traditionnelle',
    ...
    'about.howToUse': 'Comment utiliser :',
    'about.usage': [
      'Cliquez sur les dates avec des points colorés pour en savoir plus sur les fêtes',
      'Utilisez le filtre par pays pour vous concentrer sur des régions spécifiques',
      'Naviguez entre les mois en utilisant les boutons fléchés',
    ...
    'holidayModal.scrollHint': 'Faites défiler vers le bas pour lire',
    'holidayModal.loadError': 'Impossible de charger les informations détaillées. Veuillez réessayer.',
  ...
  'de': {
    ...
    'countryFilter.showAll': 'Alle Anzeigen',
    ...
    'legend.religiousObservance': 'Religiöse Feier',
    'legend.traditionalCelebration': 'Traditionelle Feier',
    ...
    'about.howToUse': 'Verwendung:',
    'about.usage': [
      'Klicken Sie auf Daten mit farbigen Punkten, um mehr über Feiertage zu erfahren',
      'Verwenden Sie den Länderfilter, um sich auf bestimmte Regionen zu konzentrieren',
      'Navigieren Sie zwischen Monaten mit den Pfeil-Tasten',
    ...
    'holidayModal.scrollHint': 'Zum Lesen nach unten scrollen',
    'holidayModal.loadError': 'Detaillierte Informationen konnten nicht geladen werden. Bitte versuchen Sie es erneut.',
  ...
  'es': {
    ...
    'countryFilter.showAll': 'Mostrar Todos',
    ...
    'legend.religiousObservance': 'Observancia Religiosa',
    'legend.traditionalCelebration': 'Celebración Tradicional',
    ...
    'about.howToUse': 'Cómo usar:',
    'about.usage': [
      'Haga clic en fechas con puntos de colores para aprender sobre fiestas',
      'Use el filtro de país para enfocarse en regiones específicas',
      'Navegue entre meses usando los botones de flecha',
    ...
    'holidayModal.scrollHint': 'Desplázate hacia abajo para leer',
    'holidayModal.loadError': 'No se pudo cargar la información detallada. Inténtalo de nuevo.',
  ...
  'zh-CN': {
    ...
    'legend.religiousObservance': '宗教节日',
    'legend.traditionalCelebration': '传统庆典',
    ...
    'holidayModal.scrollHint': '往下滑动查看详细内容',
    'holidayModal.loadError': '无法加载详细信息，请重试。',
  ...
  'zh-TW': {
    ...
    'legend.religiousObservance': '宗教節日',
    'legend.traditionalCelebration': '傳統慶典',
    ...
    'holidayModal.scrollHint': '往下滑動查看詳細內容',
    'holidayModal.loadError': '無法載入詳細資訊，請重試。',
    'holidayType.public': '公共假日',
  ...
  'ja': {
    ...
    'legend.religiousObservance': '宗教的行事',
    'legend.traditionalCelebration': '伝統的祝祭',
    ...
    'about.howToUse': '使用方法：',
    'about.usage': [
      '色付きドットのある日付をクリックして祝日について学ぶ',
      '国フィルターを使用して特定の地域に焦点を当てる',
      '矢印ボタンを使用して月間をナビゲート',
      '「今日」をクリックして現在の日付に戻る',
    ...
    'holidayModal.scrollHint': '下にスクロールしてお読みください',
    'holidayModal.loadError': '詳細情報を読み込めませんでした。もう一度お試しください。',
  ...
  'ko': {
    ...
    'legend.religiousObservance': '종교 행사',
    'legend.traditionalCelebration': '전통 축제',
    ...
    'about.howToUse': '사용 방법:',
    'about.usage': [
      '색깔 있는 점이 있는 날짜를 클릭하여 휴일에 대해 알아보기',
      '국가 필터를 사용하여 특정 지역에 집중하기',
      '화살표 버튼을 사용하여 월간 탐색하기',
    ...
    'holidayModal.scrollHint': '아래로 스크롤하여 읽어보세요',
    'holidayModal.loadError': '자세한 정보를 불러오지 못했습니다. 다시 시도해 주세요.',
